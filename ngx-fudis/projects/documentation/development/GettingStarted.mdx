...
* Node.js and NPM
  * For just running Storybook locally, any version will do as the containers will internally use correct versions anyway. If you plan to do anything else, using the version specified in `.nvmrc` is highly recommended (`v18.19.1` at the time of writing this doc).
