...
In root of the project is folder 'settings'. Fudis core developers use these settings and extensions to have mutual developer experience.

To apply these settings to your Fudis projects:
