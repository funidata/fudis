...
Check [Naming Conventions](/docs/documentation-development-naming-conventions--documentation) documentation if you are not sure about these.
...
- Disabled and invalid states should be able to switch on from ArgTypes.
