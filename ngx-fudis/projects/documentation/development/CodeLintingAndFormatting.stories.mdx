...
(enforces [JavaScript Style Guide](https://github.com/airbnb/javascript)) is used as a base for the eslint-configuration. Additionally, [typescript-eslint](https://github.com/typescript-eslint/typescript-eslint)
