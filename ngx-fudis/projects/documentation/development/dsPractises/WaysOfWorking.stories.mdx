...
Currently documented conventions for naming components, CSS classes etc. can be found in [Naming Conventions Documentation](/docs/documentation-development-naming-conventions--documentation).
...
Quite many of the formatting errors can be automatically fixed on save if you have setupped your VSCode or other IDE correctly, see [VSCode Setup Documentation](/docs/documentation-development-setup-vs-code--documentation).
