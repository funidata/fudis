...
* Component all variants, can be documented as story by using Storybook template prop.
  > *Note! This prevents component control through Controls. Template prop should be used mainly for a story spesific readme.mdx documentation.*
...
* Component has visible focus style
  > *Note! Disabled form elements receive focus*
