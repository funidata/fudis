...
export const AllVariants: StoryFn = () => ({
	template: html`
		<fudis-grid [marginBottom]="'md'" [columns]="{xs:2, md: 4}" [align]="'start'" [rowGap]="'xs'" [marginBottom]="'md'">
			...
			<fudis-heading fudisSpacing [marginTop]="'md'" [level]="4" [size]="'sm'">Small size buttons</fudis-heading>
			...
			>
			<fudis-button variant="primary" [labelHidden]="true" icon="search" label="Primary" size="small" />
			<fudis-button variant="secondary" [labelHidden]="true" icon="search" label="Secondary" size="small" />
			<fudis-button variant="tertiary" [labelHidden]="true" icon="search" label="Tertiary" size="small" />
			<fudis-button label="Disabled" [labelHidden]="true" icon="search" [disabled]="true" size="small" />

			<fudis-heading fudisSpacing [marginTop]="'md'" [level]="4" [size]="'sm'"
				>Icon only sized buttons with label hidden</fudis-heading
			>
			<fudis-button variant="primary" [labelHidden]="true" icon="search" label="Primary" size="icon-only" />
			<fudis-button variant="secondary" [labelHidden]="true" icon="search" label="Secondary" size="icon-only" />
			<fudis-button variant="tertiary" [labelHidden]="true" icon="search" label="Tertiary" size="icon-only" />
			<fudis-button label="Disabled" [labelHidden]="true" icon="search" [disabled]="true" size="icon-only" />
		</fudis-grid>
	`,
});
