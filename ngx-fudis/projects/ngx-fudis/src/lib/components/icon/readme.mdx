...
All icons have default size of 32 x 32 pixels, except icons with suffix **-small** (e. g. `alert-small`, `info-small`) which are scaled to 16x16px.
...
Icon has one **mandatory** property: `icon`. All available icons can be seen in *All Icons* story page.
