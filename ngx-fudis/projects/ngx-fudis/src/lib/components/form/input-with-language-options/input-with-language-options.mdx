...
import { inputWithLanguageOptionsDocsExclude } from "../../../utilities/storybook";
...
<ArgTypes of={InputWithLanguageOptionsComponent} exclude={inputWithLanguageOptionsDocsExclude} />
