...
<Meta title="Components/Form/Deprecated Autocomplete (single-select)" />

# Deprecated Autocomplete (single-select)
...
<Canvas of={AutocompleteStories.AutocompleteSearch} />

<Canvas of={AutocompleteStories.AutocompleteDropdown} />

## Usage Guidelines

Autocomplete is designed to use when basic [dropdown](/story/components-dropdown-menu--documentation) is not enough - that is, cases where option list has too many objects to scroll through and user has an idea what they are searching for.
