...
Fudis Form also extends Fudis Grid Api Directive which allows the modification and usage of most of the [Grid properties](/docs/foundations-grid--documentation). Non-working Grid properties are `columns` and `rowGap`.
