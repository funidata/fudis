...
export class CheckboxComponent implements OnInit, OnDestroy {
  constructor(
    ...
    @Host() protected _checkboxGroup: CheckboxGroupComponent<FudisCheckboxGroupFormGroup>,
  ) {}
  ...
  protected _onChange(): void {
    const optionToEmit: FudisCheckboxOption<object> = {
      ...
      label: this.label,
      value: (this._checkboxGroup.formGroup as FormGroup).controls[this.controlName].value,
    };
