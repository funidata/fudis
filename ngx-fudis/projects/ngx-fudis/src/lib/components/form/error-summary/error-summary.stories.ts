			...
			<fudis-error-summary>
				<fudis-form-layout>
					<fudis-vanilla-text-input
						...
						maxLength="6"
						type="password"
						helpText="Help text Nipperkin yardarm list splice the main brace draft swing the lead Privateer tack pillage bounty. Shrouds quarter gangplank belaying pin skysail fathom rope's end boom pirate spike. Topgallant line barque sloop quarter cog Jack Tar gabion pillage fire ship."></fudis-vanilla-text-input>
					<fudis-vanilla-text-input
						[required]="true"
						labelHeight="double"
						label="Label Email, pakollinen, Nipperkin yardarm list splice the main brace draft."
						type="email"
						helpText="Lorem ipsum"></fudis-vanilla-text-input>
					<fudis-vanilla-text-input
