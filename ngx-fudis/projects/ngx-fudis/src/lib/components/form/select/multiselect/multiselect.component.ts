 ...
 * value. The FormControl value is a `FudisSelectOption[]` array (not primitives).
 * Options are projected via `<ng-template fudisSelectOptions>` containing `<fudis-multiselect-option>` elements.
 *
 * @example
 * ```html
