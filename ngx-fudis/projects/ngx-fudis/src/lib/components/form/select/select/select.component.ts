 ...
 * The FormControl value is a `FudisSelectOption` object (not a primitive).
 * Options are projected via `<ng-template fudisSelectOptions>` containing `<fudis-select-option>` elements.
 *
 * @example
 * ```html
