...
- All of the Fudis Validators can be assigned to Select component.
...
Documentation for including selectable options for both Select and Multiselect is found under [Select and Multiselect Option documentation](/docs/components-form-select-select-and-multiselect-option--documentation)
