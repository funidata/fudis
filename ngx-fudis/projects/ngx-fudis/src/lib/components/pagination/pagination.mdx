...
By default focus is preserved on pagination active page item after page change. This can be turned off by setting `autoFocusOnPageChange` input to false.
By doing this, the application takes the full responsibility of moving focus somewhere else where it best supports accessibility and consistent user experience.
