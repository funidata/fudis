...
Notification Component doesn't strict what content is contained or interfere the content styling. It is recommended to use Body Text Components. The size Body Texts are set default to `lg-regular`. This can be overriden if needed.
