...
**NOTE**: All fudis-button properties are given in this example as needed, just modify `label` according to your needs and fill fudis-dropdown-menu with wanted fudis-dropdown-menu-items.
