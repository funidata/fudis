...
fdescribe('DescriptionListComponent', () => {
	...
	// 	const i = fixture.nativeElement.querySelector('fudis-dt') as HTMLElement;
	// 	console.log('Katso mikä tämä on', i);
	// 	return fixture.nativeElement.querySelector('fudis-dt') as HTMLElement;
	// }

	// function getDescriptionListDd(): HTMLElement {
	// 	return fixture.nativeElement.querySelector('fudis-dd') as HTMLElement;
	// }
	...
	// 		// assertDdHasClasses('fudis-description-list__item__details');
	// 	});
	...
	// 		// assertDdHasClasses('fudis-description-list-compact__item__details');
	// 	});
	// });
});
