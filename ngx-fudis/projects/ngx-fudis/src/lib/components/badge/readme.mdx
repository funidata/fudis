...
Text for the badge can be passed through _content_ Input or by content projection. The content should be **clear and concise**, bearing in mind that screen readers do not get any additional information about the badge but only the text content it has.
