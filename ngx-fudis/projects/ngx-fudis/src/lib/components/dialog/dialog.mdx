...
**fudisDialogTitle**: Set title for the dialog, title will stay fixed to the top of the dialog if content is long and when scrolling it down. This directive extends *MatDialogTitle*. Initial focus is set to this heading when opening the dialog.
...
**fudis-dialog-content**: Container for your scrollable dialog content. This directive extends *MatDialogContent*.
...
**fudis-dialog-actions**: Container for your dialog action buttons which stays fixed to the bottom of the dialog when scrolling. This directive extends *MatDialogActions*.
...
**fudisDialogClose**: Set dialog close button with no form submitting. This directive extends *MatDialogClose*.
