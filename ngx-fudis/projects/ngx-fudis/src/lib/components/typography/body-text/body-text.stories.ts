...
const Template: StoryFn = (args) => ({
  ...
  template: html` <fudis-grid [width]="'md'" [align]="'start'">
    <div>
      <fudis-body-text [variant]="variant" [color]="color" [align]="align"
  ...
  template: html`
    <fudis-grid [columns]="{xs: 1, md: 2}" [align]="'start'">
      ...
      <fudis-body-text [variant]="'lg-light'"
        >This paragraph has <strong>lg-light</strong> variant. Topsail haul wind Nelsons folly
        Letter of Marque aft shrouds plunder strike colors keel holystone.
      </fudis-body-text>
