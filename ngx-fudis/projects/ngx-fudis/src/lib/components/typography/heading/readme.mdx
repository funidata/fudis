...
Note that header tags does not affect to the heading size, i.e they are only essential for screen readers and other assistive technologies. 
...
- Semantically it is important to use correct header tag respective to the context
