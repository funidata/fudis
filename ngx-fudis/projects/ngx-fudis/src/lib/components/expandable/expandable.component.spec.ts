...
describe('ExpandableComponent', () => {
	...
	function hasSubTitle(): boolean {
		return !!fixture.nativeElement.querySelector('span.fudis-expandable__header__heading__button__sub-heading');
	}
	...
	function assertExpandableClassHasVariant(variant: FudisExpandableType): void {
		...
		expect(!!fixture.nativeElement.querySelector(`section.fudis-expandable__${variant}`)).toBeTruthy();
	}
	...
	function assertExpandableContentHasPadding(padding: string): void {
		...
		expect(!!fixture.nativeElement.querySelector(`div.fudis-expandable__content__padding-${padding}`)).toBeTruthy();
	}
