...
For accessibility reasons developer should set `openAriaLabel`, `closeAriaLabel` and `noResultsFound` Input strings. If not set, the strings will always be in English set by the component's default value.
