...
Grid Component columns can use any native CSS Grid units. One of the most useful is `fr` units. This enables an easy way to define columns which are not equally wide. Take a loot at the examples below.
