...
To read more about configuring default property values to all application's Grid Components and Grid Directive elements, check [FudisGridService documentation]().
