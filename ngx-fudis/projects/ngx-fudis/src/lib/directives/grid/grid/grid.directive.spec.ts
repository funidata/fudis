...
@Component({
	...
	template: `<div fudisGrid [align]="align" [alignItemsX]="alignItemsX" [alignItemsY]="alignItemxY" [columns]="3">
		...
		<div fudisGrid [columns]="2" [marginBottom]="marginBottom" [marginTop]="marginTop" [marginSides]="marginSides">
...
describe('GridDirective', () => {
	...
	describe('Attributes', () => {
		...
		it('should convert marginTop and marginBottom attributes to respective CSS classes', () => {
			...
			expect(getClasses(1, 'xs', 'xs').value).toContain('fudis-grid__margin__top__xs fudis-grid__margin__bottom__xs');

			expect(getClasses(1, 'sm', 'sm').value).toContain('fudis-grid__margin__top__sm fudis-grid__margin__bottom__sm');

			expect(getClasses(1, 'md', 'md').value).toContain('fudis-grid__margin__top__md fudis-grid__margin__bottom__md');

			expect(getClasses(1, 'lg', 'lg').value).toContain('fudis-grid__margin__top__lg fudis-grid__margin__bottom__lg');

			expect(getClasses(1, 'xl', 'xl').value).toContain('fudis-grid__margin__top__xl fudis-grid__margin__bottom__xl');
