...
Spacing directive allows you to add responsive margin attributes for desired components. Allowed inputs are same as [Spacing tokens](/docs/foundations-spacing--documentation) from `xxs` to `xxl`.
