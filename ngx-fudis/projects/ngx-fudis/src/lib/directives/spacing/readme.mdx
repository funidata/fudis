...
Below is **responsive** example. Margin-top and margin-left will be adjusted to given breakpoints. More information on breakpoints, see Fudis Foundation [breakpoints](/docs/foundations-breakpoints--documentation) documentation.
