...
/**
 * Types for extending ngOnChanges SimpleChanges type T = any FudisComponent which have @Input()
 * properties P = property of component. E. g. for Grid columns and rowGap or for Heading level and
 * size. So T[P] translates to e.g. HeadingComponent['level'] --> HeadingComponent.level --> values
 * from 1-6
 */
