...
This guide is the authoritative reference for AI coding tools implementing [Fudis](https://fudis.funidata.fi) components.
...
> _Finnish — UX and usage intent from Figma design guidelines._
