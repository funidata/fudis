...
// async function closeCalendarPopup(page: Page) {
...
//   // await page.getByTestId("fudis-datepicker-1").click(); // In case everything else fails (Safari is a pain)
//   // await page.locator("#cdk-overlay-0").waitFor({ state: "hidden", timeout: 2000 });
//   await expect(page.locator("#cdk-overlay-0")).toBeHidden({ timeout: 2000 }); // Webkit (safari desktop) is the only one failing on this one and it refuses to even generate pictures
// }
...
//   await page.evaluate(() => {
//     const popup = document.querySelector(".cdk-overlay-pane mat-datepicker-popup");
//     if (popup) {
//       popup.remove(); // or popup.style.display = 'none';
//     }
//   });
//   await expect(page).toHaveScreenshot("vidduuuu-test.png", { fullPage: true });
//   // await page.keyboard.press("Escape");
//   // await page.click("body");
//   // await page.waitForTimeout(200);
//   // await closeCalendarPopup(page);
//   await page.waitForTimeout(300);

//   await expect(page.getByText("Choose your favourite date.")).toBeVisible();
//   await page.waitForSelector(".fudis-guidance__help-text");
//   await expect(page).toHaveScreenshot("eeeeeeeeee-test.png", { fullPage: true });
...
//   await page.waitForTimeout(150);
//   // await expect(page).toHaveScreenshot("testiiiiiii.png", { fullPage: true });
