// TODO: Enable when MultiSelect is published
...
//   await page.getByRole("combobox").focus();
//   await page.locator("#fudis-multiselect-1-option-1 div").first().check();
//   await page.locator("#fudis-multiselect-1-option-3 div").first().check();
//   await expect(page).toHaveScreenshot();
// });
