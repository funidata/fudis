...
describe("Heading screenshot", () => {
  it("should match with previous screenshot, align left", () => {
    cy.visit(
      "/iframe.html?args=align:left&id=components-typography-heading--heading&viewMode=story",
    );
    fudisScreenshotInit();
  ...
  it("should match with previous screenshot, align right", () => {
    cy.visit(
      "/iframe.html?args=align:right&id=components-typography-heading--heading&viewMode=story",
    );
    fudisScreenshotInit();
  ...
  it("should match with previous screenshot, align center", () => {
    cy.visit(
      "/iframe.html?args=align:center&id=components-typography-heading--heading&viewMode=story",
    );
    fudisScreenshotInit();
