...
describe("Bodytext screenshot", () => {
  it("should match with previous screenshot, align left", () => {
    cy.visit(
      "/iframe.html?args=align:left&id=components-typography-body-text--body-text&viewMode=story",
    );
    fudisScreenshotInit();
  ...
  it("should match with previous screenshot, align right", () => {
    cy.visit(
      "/iframe.html?args=align:right&id=components-typography-body-text--body-text&viewMode=story",
    );
    fudisScreenshotInit();
  ...
  it("should match with previous screenshot, align center", () => {
    cy.visit(
      "/iframe.html?args=align:center&id=components-typography-body-text--body-text&viewMode=story",
    );
    fudisScreenshotInit();
