...
describe("Description List screenshot", () => {
  it("should match with previous screenshot, variant regular", () => {
    cy.visit(
      "/iframe.html?args=&id=components-description-list--description-list-data-loop&viewMode=story",
    );
    fudisScreenshotInit();
  ...
  it("should match with previous screenshot, DL inside Grid", () => {
    cy.visit(
      "/iframe.html?args=&id=components-description-list--description-list-item-inside-grid&viewMode=story",
    );
    fudisScreenshotInit();
  ...
  it("should match with previous screenshot, sub components regular", () => {
    cy.visit(
      "/iframe.html?args=&id=components-description-list--description-list-with-sub-components&viewMode=story",
    );
    fudisScreenshotInit();
  ...
  it("should match with previous screenshot, with language badges", () => {
    cy.visit(
      "/iframe.html?args=&id=components-description-list--description-list-with-languages&viewMode=story",
    );
    fudisScreenshotInit();
