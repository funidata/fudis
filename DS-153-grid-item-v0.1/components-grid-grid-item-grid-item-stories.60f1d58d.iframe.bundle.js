"use strict";(self.webpackChunkngx_fudis=self.webpackChunkngx_fudis||[]).push([[9625],{"./projects/ngx-fudis/src/lib/components/grid/grid-item/grid-item.stories.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{AlignX:()=>AlignX,AlignY:()=>AlignY,Example:()=>Example,alignXAndY:()=>alignXAndY,default:()=>__WEBPACK_DEFAULT_EXPORT__,gridColumn:()=>gridColumn});var _storybook_angular__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/@storybook/angular/dist/index.mjs");const __WEBPACK_DEFAULT_EXPORT__={title:"Components/Grid/Grid Item",component:__webpack_require__("./projects/ngx-fudis/src/lib/components/grid/grid-item/grid-item.component.ts").b,decorators:[(0,_storybook_angular__WEBPACK_IMPORTED_MODULE_0__.componentWrapperDecorator)((story=>`\n\t\t\t<style>\n\t\t\t.grid-test-item{\n\t\t\t\tborder: 3px solid cornflowerblue;\n\t\t\t}\n\t\t\t</style>\n\t\t\t<div style="border: 3px solid orangered">\t\n\t\t${story}\n\t\t</div>`))],argTypes:{alignX:{control:{type:"radio"}},alignY:{control:{type:"radio"}}},parameters:{controls:{exclude:["columnsToApply","ngOnInit","breakpointObserver","columnsFromInput","gridWidths","gridWidthsArray"]}}},html=String.raw,Example=(args=>({props:args,template:html` <fudis-grid [columns]="4">
	...
	</fudis-grid>`})).bind({});Example.args={alignX:"strecth",alignY:"strecth"};const AlignX=args=>({props:args,template:html`<fudis-grid [columns]="'1fr 1fr 1fr 1fr'">
	...
	</fudis-grid>`}),AlignY=args=>({props:args,template:html`<fudis-grid [columns]="'1fr 1fr 1fr 1fr'">
	...
	</fudis-grid>`}),alignXAndY=args=>({props:args,template:html`<fudis-grid [columns]="'1fr 1fr 1fr 1fr'">
		<fudis-heading class="grid-test-item" tag="h1" size="l"
	...
	</fudis-grid>`}),gridColumn=args=>({props:args,template:html`<fudis-grid [columns]="6">
		<fudis-heading class="grid-test-item" tag="h1" size="l"
...
//# sourceMappingURL=components-grid-grid-item-grid-item-stories.60f1d58d.iframe.bundle.js.map